...
twitter_bot_token <- rtweet::rtweet_bot(
  api_key       = "T4ed1008XViUHQLPMBidFKFSd",
  api_secret    = "IOlyKb1F3y7acIFNkUSmv7xvoKaEFKgOvvj1BNQFJG31cb1Ux0",
  access_token  = "1550547111418142720-5F731xC0312z8mnB0sVi2bJscB1bAO",
  access_secret = "CK2lwevbhMp5zuuCyRWoUsz7d0pFQHP8npm7FH974Q4LQ"
)
